...
export const mainAdmCategories: TCardProps[] = [
  ...
  },
  {
    ...
    customWidth: true,
    url: "/j/adm/categories", //criar página de listagem de empresas com o status, se está pago ou não. pegar exemplo de solicitações.
  },
  // {
  //     icon: cardapio,
  //     title: "Meu cardápio",
