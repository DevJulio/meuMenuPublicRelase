...
const foods: TProducts[] = [
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "Para os Dadinhos de tapioca, uma cerveja IPA ou uma caipirinha são excelentes opções para equilibrar o sabor picante.",
    description:
      "Estes dadinhos crocantes feitos com tapioca são uma opção saudável e saborosa para petiscar. Servem-se quentes e são ideais para acompanhar uma bebida gelada",
    price: "15,00",
    category: "Entradas",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "Bruschettas suíças são bem acompanhadas por vinhos brancos mais encorpados como um Gewürztraminer ou um Riesling.",
    description:
      "Fatias de pão de forma torradas com queijo suíço derretido e tomates frescos picados.",
    price: "20,00",
    category: "Entradas",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "O Ceviche é perfeito com uma taça de vinho branco fresco, como um Vinho Verde ou um Sauvignon Blanc.",
    description:
      "Um prato típico da culinária peruana, feito com peixe branco marinados em limão, cebola roxa e pimenta. Servido com tortilhas de milho crocantes.",
    price: "35,00",
    category: "Entradas",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "O Croque madame combina bem com cervejas de trigo, como a Witbier.",
    description:
      "Um sanduíche quente feito com pão de miga, presunto, queijo gruyère e uma gema de ovo por cima. Um clássico francês perfeito para um café da manhã ou lanche da tarde. ",
    price: "25,00",
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "O Croque monsieur combina bem com cervejas de trigo, como a Witbier.",
    description:
      "Um sanduíche quente feito com pão de miga, presunto e queijo gruyère. Uma opção fácil e saborosa para um lanche rápido.",
    price: "20,00",
    category: "Primeiro Prato",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "Os Ovos Benedict pedem por uma taça de champanhe brut para realçar o sabor suave dos ovos e do molho hollandaise.",
    description:
      "Ovos pochês servidos sobre muffins ingleses, presunto e molho holandês. Um café da manhã elegante e satisfatório.",
    price: "25,00",
    category: "Primeiro Prato",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "O Croissant recheado com presunto e queijo é uma combinação clássica de café com leite, um Capuccino ou um Café Latte são opções ideais.",
    description:
      "Croissants quentes e crocantes recheados com presunto e queijo derretido. Perfeito para um café da manhã ou lanche da tarde.",
    price: "20,00",
    category: "Primeiro Prato",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    description:
      "Uma salada clássica feita com folhas de alface romana, croutons crocantes, queijo parmesão e um molho Ceasar delicioso.",
    price: "25,00",
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "Salada Caprese pede por um vinho tinto italiano como um Chianti",
    description:
      "Tomates frescos, mussarela de búfala e manjericão fresco dispostos em camadas e regados com um pouco de azeite extra-virgem e sal. Uma opção saudável e saborosa.",
    price: "20,00",
    category: "Prato Principal",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "A Quiche de espinafre com queijo harmoniza com um vinho tinto leve como um Pinot Noir.",
    description:
      "Uma mistura de espinafre fresco, queijos suaves e creme de leite em um delicioso crust de massa folhada. Serve bem quente ou frio como um almoço leve ou jantar.",
    price: "25,00",
    category: "Prato Principal",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "Para a Salada Waldorf, um vinho branco seco como um Pinot Grigio é uma boa escolha.",
    description:
      "Uma salada clássica feita com maçãs cortadas em cubinhos, nozes torradas, uvas vermelhas e um toque de suave maionese. ",
    price: "20,00",
    category: "Prato Principal",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "O Naked cake de frutas vermelhas pede por uma taça de champanhe rosé",
    description:
      "Um naked cake simples e elegante feito com uma camada de bolo de frutas vermelhas, coberto com chantilly e frutas frescas. (Torta com 8 fatias)",
    price: "50,00",
    category: "Sobremesas",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "Cookies com gotas de chocolate são bem acompanhados por um leite quente com uma pitada de canela.",
    description:
      "Cookies macios e cheios de gotas de chocolate. Perfeitos para um lanche da tarde ou como sobremesa. (6 un.)",
    price: "15,00",
    category: "Sobremesas",
    categoryIcon: "",
    isDrink: false,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "O Aperol Spritz, um cocktail italiano refrescante, harmoniza bem com aperitivos como o Antepasto de tomate.",
    description:
      "Em sua composição vai Prosecco, Aperol, Água com gás e gelo. Combina muito com queijos e canapés, e ainda para melhorar, pode escoltar saladas, peixes e carnes brancas.",
    price: "30,00",
    category: "Bebidas",
    categoryIcon: "",
    isDrink: true,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "O Bloody Mary pede por snacks salgados, como amendoins torrados ou chips de batata.",
    description:
      "Vai vodka, polpa de tomate, sopa de glutamato monossódico, molho inglês, pimenta tabasco, suco de limão, gelo, tomatinho cereja para decoração e talo de salsão para decoração. Esse drink possui umami e a dica é harmonizar com frutos do mar, ostras e carnes",
    price: "30,00",
    category: "Bebidas",
    categoryIcon: "",
    isDrink: true,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "O Mojito, um coquetel cubano, combina bem com pratos de frutos do mar, como o Ceviche.",
    description:
      "O primo cubano da nossa caipirinha! Na sua formação vai limão, rum branco, hortelã, gelo, açúcar e refrigerante de soda ou água com gás. Vai bem com tomates ou alimentos mais gordurosos.",
    price: "30,00",
    category: "Bebidas",
    categoryIcon: "",
    isDrink: true,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "O Clericot, um vinho branco com frutas, é uma bebida refrescante para acompanhamento de saladas e comidas leves.",
    description:
      "Feito com vinho branco seco, licor de laranja ou cereja, limão, frutas vermelhas e outra seleção de frutas variadas. Vai bem com pratos leves, como saladas, por exemplo.",
    price: "30,00",
    category: "Bebidas",
    categoryIcon: "",
    isDrink: true,
  ...
  },
  {
    ...
    qtd: 1,
    harmoziation:
      "Café preto é uma opção clássica para acompanhar o café da manhã",
