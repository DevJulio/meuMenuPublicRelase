export const liteDetails = [
    "adesivos em alto relevo com QR CODE",
    "mantenha Até 30 itens",
    "total customização",
    "Menu de promoções",
    "um mês de teste ",
    "Cadastro básico",
...
export const proDescription = [
    "O plano Pro permite que seus clientes façam reservas das mesas via site, seu únco trabalho será habilitar no Meu Menu ADM a opção de reservas e informar quantas mesas ainda estão disponíveis!",
